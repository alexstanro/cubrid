...
extern int css_readn (SOCKET fd, char *ptr, int nbytes, int timeout, int *count_available_bytes);
extern void css_read_remaining_bytes (SOCKET fd, int len, int *p_count_available_bytes);

extern int css_net_recv (SOCKET fd, char *buffer, int *maxlen, int timeout, int *p_count_available_bytes);
...
extern int css_net_read_header (SOCKET fd, char *buffer, int *maxlen, int timeout, int *p_count_available_bytes);
