...
extern int css_read_header (CSS_CONN_ENTRY * conn, const NET_HEADER * local_header, int *p_count_available_bytes);
extern int css_receive_request (CSS_CONN_ENTRY * conn, unsigned short *rid, int *request, int *buffer_size);
extern int css_read_and_queue (CSS_CONN_ENTRY * conn, int *type, int *p_count_available_bytes);
