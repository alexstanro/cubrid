...
typedef enum
{
  ...
  PSTAT_PB_NUM_GET_VICTIM_FROM_FLUSHED_PAGE,
  PSTAT_PB_NUM_VICTIM_CANDIDATES_UNDER_QUOTA,
  ...
  PSTAT_PB_VICTIM_ASSIGN_FROM_FLUSHED_PAGES,
  PSTAT_PB_VICTIM_ASSIGN_DIRECT_PANIC,
  PSTAT_PB_VICTIM_ASSIGN_DIRECT_ADJUST,
  PSTAT_PB_VICTIM_ASSIGN_DIRECT_ADJUST_TO_VACUUM,
  PSTAT_PB_VICTIM_SKIP_NON_DIRTY,
  PSTAT_PB_VICTIMIZED_VACUUMABLE_PAGES,
  PSTAT_PB_VICTIM_SKIP_LIST_LAST_DIRTY,
