...
PSTAT_METADATA pstat_Metadata[] = {
  ...
  /* Unlocking */
  PSTAT_METADATA_INIT_COUNTER_TIMER (PSTAT_LOCK_UNLOCK_OBJECT_TIME_COUNTERS, "Time_lock_unlock_object"),
  PSTAT_METADATA_INIT_COUNTER_TIMER (PSTAT_LOCK_UNLOCK_OBJECT_LF_TIME_COUNTERS, "Time_lock_unlock_object_lf"),
