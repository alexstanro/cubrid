...
PSTAT_METADATA pstat_Metadata[] = {
  ...
  PSTAT_METADATA_INIT_SINGLE_ACC (PSTAT_PB_NUM_SKIPPED_SEARCH_FOR_VICTIM, "Num_skipped_search_for_victim"),
  ...
  PSTAT_METADATA_INIT_SINGLE_ACC (PSTAT_PB_VICTIM_ASSIGN_FROM_FLUSHED_PAGES, "Num_victim_assign_from_flushed_pages"),
